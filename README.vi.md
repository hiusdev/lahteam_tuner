...
**Thư viện hỗ trợ train LoRA trên Google Colab** - Hỗ trợ FLUX.2, Qwen Image, và Z-Image Turbo.
...
> ⭐ **Khuyến nghị**: Sử dụng `klein_base_*` cho training LoRA
...
# Trả về: {"vae_path": ..., "text_encoders_path": ..., "dit_path": ...}
...
path = create_dataset_config(
    ...
    control_dir="/path/to/control",  # Tùy chọn
...
├── config.py        # Cấu hình models (QWEN, FLUX.2)
├── download.py      # Functions tải model
...
- [kohya-ss/musubi-tuner](https://github.com/kohya-ss/musubi-tuner) - Framework training gốc
- [Comfy-Org](https://huggingface.co/Comfy-Org) - Hosting FLUX.2 models
- [Qwen](https://huggingface.co/Qwen) - Qwen Image models

---

<p align="center">
  <sub>🤖 Dự án này được phát triển với sự hỗ trợ của AI (Claude/Gemini)</sub>
</p>
